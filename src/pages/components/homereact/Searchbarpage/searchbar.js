    ...
    const handleFetchJobs = async (e) => {
        ...
        try {
        await Promise.all([
            axios.post('http://localhost:3003/fetch-jobs', {
            job_title: jobTitle,
            location: location,
            }),
            ...
            axios.post('http://localhost:3002/fetch-jobs', {
                job_title: jobTitle,
                location: location,
    ...
    const fetchJobs = async () => {
        ...
        const [indeedResponse, linkedinResponse, stepstoneResponse, glassdoorResponse] = await Promise.all([
            axios.get('http://localhost:3003/indeed-get-jobs'),
            axios.get('http://localhost:3001/get-jobs'),
            axios.get('http://localhost:3002/stepstone-get-jobs'),
            axios.get('http://localhost:3004/glassdoor-get-jobs'),
        ]);
